            ...
            <div class="card-body">
                <form action="{{ route('admin#postCreate') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="postTitle" value="{{ old('postTitle') }}" placeholder="Post Title"
                            class=" form-control">
                        @error('postTitle')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="postDescription" placeholder="Description" class="form-control" cols="30" rows="10">{{ old('postDescription') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="postImage" placeholder="Post Title" class=" form-control">
                        @error('postImage')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
